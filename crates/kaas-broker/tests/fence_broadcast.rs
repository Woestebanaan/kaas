...
//! each side independently — [`FenceLog::append`] (kaas-coordinator)
//! and [`FenceWatcher::tick`] (kaas-broker). This file wires them
...
use kaas_broker::{FenceWatcher, ProducerEpochFencer};
use kaas_coordinator::{fence_log_dir, FenceLog};
