...
//!
//! Translates the codec request into [`sk_coordinator::JoinRequest`],
...
//!
//! [`Manager::join_group`]: sk_coordinator::Manager::join_group
//! [`JoinOutcome`]: sk_coordinator::JoinOutcome
...
use sk_codec::api::join_group;
use sk_coordinator::{JoinRequest, ProtocolMetadata};
