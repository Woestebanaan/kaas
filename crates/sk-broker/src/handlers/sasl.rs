...
use sk_codec::api::{sasl_authenticate, sasl_handshake};
...
mod tests {
    use super::*;
    use sk_auth::credentials::TestCred;
    use sk_auth::engine::RealAuthEngine;
    use sk_auth::selector::SingleAuthEngine;
    use sk_auth::{AuthEngine, CredentialLoader, PrincipalMapper};
    use sk_codec::api::common::write_str;
    use sk_codec::primitives::write_compact_bytes;
    use sk_codec::tagged;
