...
use kube::{Api, Client};
use sk_operator_api::{Condition, KafkaUser, KafkaUserScramCredential, KafkaUserStatus};
...
fn owner_ref_for(
    ...
    k8s_openapi::apimachinery::pkg::apis::meta::v1::OwnerReference {
        api_version: format!("{}/{}", sk_operator_api::GROUP, sk_operator_api::VERSION),
        kind: "KafkaUser".into(),
...
mod tests {
    ...
    use super::*;
    use sk_operator_api::{KafkaUserAuthentication, KafkaUserScramCredential, LocalObjectRef};
    ...
    fn owner_ref_for_carries_controller_flag() {
        let user = KafkaUser {
            ...
            spec: sk_operator_api::KafkaUserSpec {
